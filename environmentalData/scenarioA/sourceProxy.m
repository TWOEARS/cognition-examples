         ...
         function generateSchedule(obj)
            ...
            while t<obj.stopTime
                if t<obj.timeOfEvent
                    ...
                    stress=min(max(nrnd(obj.preEventStressDistribution(1,1),...
                        obj.preEventStressDistribution(1,2)),0),1);
                    loudness=min(max(nrnd(obj.preEventLoudnessDistribution(1,1),...
                    ...
                    stress=min(max(nrnd(obj.postEventStressDistribution(1,1),...
                        obj.postEventStressDistribution(1,2)),0),1);
                    loudness=min(max(nrnd(obj.postEventLoudnessDistribution(1,1),...
